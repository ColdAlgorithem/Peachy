...
public class HeightMapMesh {
    ...
    public HeightMapMesh(float minY,float maxY,String heightMapFile,String textureFile,int textInc) throws Exception{
        ...
        for(int row=0;row<height;row++){
            for(int col=0;col< width;col++){
                ...
                pos.add(getHeight(col, row, width, buf));
        ...
        float[] posArr = Utils.listToArray(pos);
    ...
    public static float getXLength(){return Math.abs(-STARTX*2);}

    public static float getZLength(){return Math.abs(-STARTZ*2);}
